...
export function hydrateStoreFromSettings(settings: GlobalSettings): void {
  ...
  useAppStore.setState({
    ...
    accountFailoverSettings: settings.accountFailoverSettings ?? {
      enabled: true,
...
function buildSettingsUpdateFromStore(): Record<string, unknown> {
  ...
  return {
    ...
    anthropicAccounts: state.anthropicAccounts,
    accountFailoverSettings: state.accountFailoverSettings,
